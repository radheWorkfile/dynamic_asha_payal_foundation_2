...
function delete_donation_enquiry(id) {
    $.ajax({
        url: base_url + "admin/Donation/delete_donation_enquiry",
        type: "POST",
        data: { "id": id },
        success: function(data) {
            //$('#empmsg').html(data);
...
function view_donation_enquiry(id) {
    $.ajax({
        url: base_url + "admin/Donation/view_donation_enquiry",
        type: "POST",
        data: { "id": id },
        success: function(data) {
            $("#view_donation_details").html(data);
        }
