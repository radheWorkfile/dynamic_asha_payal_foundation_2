    ...
    class Website extends CI_Controller
    {
        ...
        public function contact_us()
        {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($this->db->insert('admin_enquiry', $data)) {
                    $this->session->set_flashdata('message_display', '<div class="alert alert-success">Data added successfully, your information has been saved.</div>');
                    redirect('Website/page/28');
                } else {

                    $this->session->set_flashdata('message_display', '<div class="alert alert-danger">An error occurred; something went wrong with your request.</div>');
                    redirect('Website/page/28');
                }
            } else {
                $this->session->set_flashdata('message_display', '<div class="alert alert-danger">You must fill out every section, no part can be left uncompleted.</div>');
                redirect('Website/page/28');
...
public function registration_1()
{
        ...
        if($this->form_validation->run() == TRUE) {
            ...
            if($this->db->insert('admin_enquiry', $data)){
            $data=array('msg' => array("Registration successful"), 'adClas' => 'tSuccess','icon'=>'<i class="fa fa-check" aria-hidden="true"></i> ');
            }
           } else {
            $data = array(
           ...
           $data=array('msg' => $data, 'adClas' => 'tDanger','icon'=>'<i class="fa fa-cog" aria-hidden="true"></i> ');
        }
