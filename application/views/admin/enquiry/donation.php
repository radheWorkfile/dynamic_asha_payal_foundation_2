            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($donation_enquiry as $us => $enq) { ?>
                                <tr>
                                    <td><?php echo $us + 1; ?></td>
                                    <td><?php echo $enq['first_name'].''.$enq['last_name']?></td>
                                    <td><?php echo $enq['mobile']; ?></td>
                                    <td><?php echo $enq['email']; ?></td>
                                    <td><img src="<?php echo base_url('uploads/payment_details/'.$enq['payment_img']);?>" alt=""style="height:1rem;"class="zoom"></td>
                                    <td>
                                        <style>
            .zoom:hover{-ms-transform: scale(11); -webkit-transform: scale(11); transform: scale(11);}                                     </style>

                                    <!-- echo base_url('uploads/payment_details/'.$enq['payment_img']); -->

                                    <a href="javascript:void(0);" onclick="view_donation_enquiry(<?php echo $enq['id'];?>)" data-toggle="modal" data-target="#view_modal" title='View more <?php echo $enq['menu'] ?> '><i class="fas fa-eye text-info"></i></a>&emsp;

                                       <a href="javascript:void(0);" onclick="delete_donation_enquiry(<?php echo $enq['id'] ?>)" title='Click to Delete  '><i class="fas fa-trash text-danger"></i></a>&emsp;
    ...
    <div class="modal fade" id="view_modal">
        <div class="modal-dialog modal-sm">
            <div class="modal-content text-sm">
                ...
                <div class="modal-body">
                    <div id="view_donation_details"></div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
