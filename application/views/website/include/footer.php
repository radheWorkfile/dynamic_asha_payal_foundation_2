            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-2 col-sm-6 col-xs-12 column" style="margin-top:4rem;">
                    ...
                    <div class="footer-widget links-widget">
                        <ul>
                            <li><a href="<?php echo base_url(); ?>Website/page/18">Home</a></li>
                            <li><a href="<?php echo base_url(); ?>Website/page/19">About Us</a></li>
                            <li><a href="<?php echo base_url(); ?>Website/page/21">Events</a></li>
                            <li><a href="<?php echo base_url(); ?>Website/page/27">Gallery</a></li>
                            <li><a href="<?php echo base_url(); ?>Website/page/28">Contact</a></li>
                        </ul>
                ...
                <div class="donation-form-outer">
                    ...
                    <form method="post" action="javaScript:void(0);" id="donation_enquiry">
                        ...
                        <div class="form-portlet">
                            ...
                            <h4><span>How Much Would you like to Donate?</span></h4>
                            <h2 id="getMass">&nbsp;</h2>
                        ...
                        <div class="text-left">
                            <input type="submit" name="submit" id="submit" onclick=" return validatedebit()" class="theme-btn btn-style-two" style="border:5px solid red;">
                        </div>
...
<script>
    $("#donation_enquiry").on("submit", function(e) {
        e.preventDefault();
        alert("fsdfd");
        $.ajax({
            type: "post",
            ...
            success: function(data) {
                ...
                if (data.icon == 'error') {
                    if (data.text.fname != "") {
                        $("#fnameErr").html(data.text.fname).fadeIn().delay(3000).fadeOut();
                    }
                    if (data.text.lname != "") {
                        $("#lnameErr").html(data.text.lname).fadeIn().delay(3000).fadeOut();
                    }
                    if (data.text.email != "") {
                        $("#emailErr").html(data.text.email).fadeIn().delay(3000).fadeOut();
                    }
                    if (data.text.mobile != "") {
                        $("#mobileErr").html(data.text.mobile).fadeIn().delay(3000).fadeOut();
                    }
                    if (data.text.address != "") {
                        $("#addressErr").html(data.text.address).fadeIn().delay(3000).fadeOut();
                    }
                    if (data.text.amount != "") {
                        $("#amountErr").html(data.text.amount).fadeIn().delay(3000).fadeOut();
                    }
                    if (data.text.payment_img != "") {
                        $("#payment_imgErr").html(data.text.payment_img).fadeIn().delay(3000).fadeOut();
                    }
